...
(function() {
    ...
    const translations = {
        es: {
            ...
            expIntro: 'Experiencia en producto B2B (telecom), entrenamiento de modelos de IA y divulgación técnica.',
            ...
            expRole2: 'AI Training Specialist — Outlier',
            expRole2Meta: 'nov. 2024 – actualidad · Freelance · Remoto',
            expRole2Li1: 'Entrenamiento de modelos de IA multilingües (español/inglés) mediante redacción, clasificación y evaluación de prompts.',
            expRole2Li2: 'Revisión y validación de respuestas generadas por IA en contextos de programación (JavaScript, TypeScript, Python, HTML/CSS, Node.js).',
            expRole2Li3: 'Colaboración en proyectos de fine-tuning para mejorar la precisión y coherencia de sistemas conversacionales.',
            expRole3: 'Instructor online — Udemy',
            expRole3Meta: '2018 – actualidad',
            expRole3Li1: 'Curso: "Aplicación web dinámica con Angular 9, Bootstrap y NodeJS (MEAN)". <a href="https://www.udemy.com/course/angular-bootstrap-y-nodejs/" target="_blank" rel="noreferrer">Ver curso</a>.',
            expRole3Li2: 'Calificación 4,3/5 · 218 valoraciones · 10.533 estudiantes.',
            expRole4: 'Creador de contenido — YouTube "Yustgo"',
            expRole4Meta: '2018 – actualidad',
            expRole4Li1: 'Divulgación técnica sobre Angular y desarrollo web (tutoriales, buenas prácticas y ejemplos). <a href="https://www.youtube.com/@yustgo2631" target="_blank" rel="noreferrer">Ver canal</a>.',
            expRole4Li2: '304 suscriptores · 20 vídeos · 47.560 visualizaciones · activo desde 14/03/2020.',
        ...
        en: {
            ...
            expTitle: 'Experience',
            expIntro: 'Experience in B2B product (telecom), AI model training, and technical content.',
            ...
            expRole2: 'AI Training Specialist — Outlier',
            expRole2Meta: 'Nov 2024 – present · Freelance · Remote',
            expRole2Li1: 'Training multilingual AI models (Spanish/English) through prompt writing, classification, and evaluation.',
            expRole2Li2: 'Review and validation of AI-generated responses in programming contexts (JavaScript, TypeScript, Python, HTML/CSS, Node.js).',
            expRole2Li3: 'Collaboration on fine-tuning projects to improve accuracy and coherence of conversational systems.',
            expRole3: 'Online instructor — Udemy',
            expRole3Meta: '2018 – present',
            expRole3Li1: 'Course: "Dynamic web app with Angular 9, Bootstrap and NodeJS (MEAN)". <a href="https://www.udemy.com/course/angular-bootstrap-y-nodejs/" target="_blank" rel="noreferrer">View course</a>.',
            expRole3Li2: 'Rating 4.3/5 · 218 reviews · 10,533 students.',
            expRole4: 'Content creator — YouTube "Yustgo"',
            expRole4Meta: '2018 – present',
            expRole4Li1: 'Technical content on Angular and web development (tutorials, best practices, real examples). <a href="https://www.youtube.com/@yustgo2631" target="_blank" rel="noreferrer">View channel</a>.',
            expRole4Li2: '304 subscribers · 20 videos · 47,560 views · active since 2020‑03‑14.',
